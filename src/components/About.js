...
import mountains from "../wallhaven-p8x6mm_1920x1080.png";
...
export default function About() {
    ...
    return (
        <main className="relative">
           <img src={mountains} alt="mountains with trees" className="absolute w-full"/>
               ...
               <section className="bg-purple-800 rounded-lg shadow-2xl lg:flex p-20">
                   ...
                   <div className="text-lg flex flex-col justify-center">
                       ...
                       <div className="prose lg:prose-xl text-white">
                           <BlockContent blocks={author.bio} projectId="19oolmj2" dataset="prodution"/>
                       </div>
                   </div>
                </section>
            </div> 
