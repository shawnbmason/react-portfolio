                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <article>
                        <Link to={"/post/" + post.slug.current} key={post.slug.current}>
                         <span 
                            className="block h-64 relative rounded shadow leading-slug bg-white border-l-8 border-blue-400" 
                            key={index}
                         >
                             <img 
                             ...
                             <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                 <h3 className="text-grey-800 text-lg font-blod px-3 py-4 bg-red-700 text-red-100 bg-opacity-75 rounded">
                                     {post.title}
                                 </h3>
                             </span>
                         </span>
